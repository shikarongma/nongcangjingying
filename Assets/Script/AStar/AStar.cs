...
namespace MFarm.AStar
{
    public class AStar : Singleton<AStar>
    {
        ...
        {
            if (GridMapManager.Instance.GetGridDimensions(sceneName, out Vector2Int gridDimensions/*网格范围*/, out Vector2Int gridOrigin/*网格原点*/))
            {
            ...
            //gridNodes的范围是从0,0开始所以需要减去原点坐标得到实际位置（意思是该案例的A*算法坐标是以0，0开始的，
            //不是游戏里的实际坐标）
        ...
        /// <summary>
        /// 更新路径每一步的坐标和场景名字，从后往前压栈，即栈顶为第一步
        /// </summary>
        /// <param name="sceneName"></param>
